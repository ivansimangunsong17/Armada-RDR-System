...
import TruckDurationReportPage from '../pages/TruckDurationReportPage.jsx'
...
export const roleRoutes = {
  admin: [
    ...
    {
      path: '/admin/truck-duration-report',
      label: 'Truck Duration',
      icon: FaClock,
      hidden: true,
      element: (appState) => <TruckDurationReportPage appState={appState} />,
    },
    {
  ...
  checker: [
    ...
    {
      path: '/checker/truck-duration-report',
      label: 'Truck Duration',
      icon: FaClock,
      hidden: true,
      element: (appState) => <TruckDurationReportPage appState={appState} />,
  ...
  viewer: [
    ...
    {
      path: '/viewer/truck-duration-report',
      label: 'Truck Duration',
      icon: FaClock,
      hidden: true,
      element: (appState) => <TruckDurationReportPage appState={appState} />,
    ...
    {
      path: '/supervisor/truck-duration-report',
      label: 'Truck Duration',
      icon: FaClock,
      hidden: true,
      element: (appState) => <TruckDurationReportPage appState={appState} />,
