...
function App() {
  ...
  async function applyAuthUser(authUser) {
    const { profile, error } = await authService.getProfileByUserId(authUser.id)
    ...
    const nextUser = authService.mapProfileToCurrentUser(profile, authUser)
  ...
  async function handleLogin(identifier, password) {
    ...
    try {
      const { user, error } = await authService.signInWithLoginIdentifier(identifier, password)
