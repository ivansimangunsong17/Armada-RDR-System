...
import { buildTimedReportSummary } from '../utils/calculations.js'
...
function ShiftReportPage({ appState }) {
  ...
  async function loadReport() {
    ...
    const result = await reportService.getShiftReport({
    ...
    if (result.error) {
      setError('Gagal memuat report shift dari server.')
    }
